...
class ResetPasswordController extends AbstractController
{
    ...
    public function checkEmail(): Response
    {
        ...
        return $this->render('reset_password/check_email.html.twig', [
            ...
            'page_title' => 'Vérifier vos emails',
        ]);
    }
    ...
    private function processSendingPasswordResetEmail(string $emailFormData, MailerInterface $mailer, TranslatorInterface $translator): RedirectResponse
    {
        ...
        $this->logger->error($emailFormData);
        ...
        try {
            ...
            $email = (new TemplatedEmail())
                ->from(new Address('matthieu.boubeedegramont@limayrac.fr', 'Symfony projet'))
                ->to($user->getEmail())
            ...
            $this->addFlash('reset_password_success', sprintf(
                '%s',
                $translator->trans('Email envoyé avec succés'),
            ));
            return $this->redirectToRoute('app_forgot_password_request');
